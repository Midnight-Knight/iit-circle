...
const data: dataType = {
    ...
    "infrastructure-1-1": {
        ...
        "jobTitle": "Стажёр",
        "jobDescription": [
            "Первый шаг в профессии. Знакомится с устройством ИТ-инфраструктуры, помогает команде в выполнении простых задач и постепенно разбирается в инструментах и процессах эксплуатации.",
    ...
    "iot-1-1": {
        ...
        "jobTitle": "Стажёр",
        "jobDescription": [
            "Первый шаг в профессии. Знакомится с устройством вычислительных систем и принципами работы встраиваемых решений, помогает команде в выполнении простых задач и постепенно погружается в специфику разработки аппаратных и программных компонентов.",
    ...
    "management-1-1": {
        ...
        "jobDescription": [
            "Первый шаг в профессии. Создаёт и поддерживает техническую документацию продуктов и систем: руководства пользователя, технические спецификации, описания API и внутренние регламенты. Делает сложные технические вещи понятными для разных аудиторий.",
